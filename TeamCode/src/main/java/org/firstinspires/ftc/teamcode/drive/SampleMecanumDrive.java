...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    //private IMU imu;          // 3 wheel odometry doesn't need imu
    ...
    /**
     * setWheelVelocities   - set the velocities of each wheel
     * @return          List of each velocity
     */
    @Override
    ...
    /**
     * setMotorPowers   - set the double power for each motor
     * @param   v       leftFront
     * @param   v1      leftRear
     * @param   v2      rightRear
     * @param   v3      rightFront
